...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['hero'])){
    ...
    if(empty($formErrors)){
            $emails = array("mohammad.mekawy@happenize.com");
			...
			for($i=0;$i<count($emails);$i++){
				...
				$mail->Host = 'vowalaa.com';             // Specify main and backup SMTP servers
				$mail->SMTPAuth = true;                     // Enable SMTP authentication
				$mail->Username = 'lp@vowalaa.com';          // SMTP username
				$mail->Password = '3htZ8o#PN6Qk'; // SMTP password
				$mail->SMTPSecure = 'ssl';                            
				$mail->Port = 465;  
				$mail->isHTML(true);  // Set email format to HTML

				$mail->setFrom('lp@vowalaa.com');
               ...
               $bodyContent .= '<h3 style="font-size:18px; margin-bottom:12px;">COMPANY: '. $COMPANY .'</h3><br>';
               $bodyContent .= '<h3 style="font-size:18px; margin-bottom:12px;">INDUSTRY: '. $INDUSTRY .'</h3><br>';

               $mail->Subject = 'Vowalaa LP';
